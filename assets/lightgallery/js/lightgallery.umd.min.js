! function (t, e) {
    ...
    S.generateUUID = function () {
        ...
        return this.selector && void 0 !== this.selector.length ? T(this.selector[0]) : T(this.selector)
    ...
    var O = function (t, e, i, s) {
        ...
        D = function (t, e, i, s, n) {
            if (n) {
                var o, r, l, a, t = T(t).find("img").first();
        ...
        B = function (t, e, d, g) {
            ...
            return [].forEach.call(t, function (t) {
                for (var e = {}, i = 0; i < t.attributes.length; i++) {
                    var s, n, o = t.attributes[i];
                    o.specified && (s = "href" === (s = o.name) ? "src" : (s = (s = s.replace("data-", "")).charAt(0).toLowerCase() + s.slice(1)).replace(/-([a-z])/g, function (t) {
                        return t[1].toUpperCase()
                    }), n = "", (n = -1 < c.indexOf(s) ? s : n) && (e[n] = o.value))
                }
                var r = T(t),
                    l = r.find("img").first().attr("alt"),
                    a = r.attr("title"),
                    r = g ? r.attr(g) : r.find("img").first().attr("src");
                e.thumb = r, d && !e.subHtml && (e.subHtml = a || l || ""), e.alt = l || a || "", h.push(e)
            }), h
        },
        F = function () {
        ...
        P = 0,
        _ = (t.prototype.generateSettings = function (t) {
            this.settings = e(e({}, b), t), (this.settings.isMobile && "function" == typeof this.settings.isMobile ? this.settings.isMobile() : F()) && (t = e(e({}, this.settings.mobileSettings), this.settings.mobileSettings), this.settings = e(e({}, this.settings), t))
            ...
            for (var n = this, o = this, t = 0; t < this.items.length; t++) ! function (e) {
                var i = o.items[e],
                    t = T(i),
                    s = w.generateUUID();
            ...
            this.settings.licenseKey ? "1234-4567-890-1234" === this.settings.licenseKey && console.warn("lightGallery: " + this.settings.licenseKey + " license key is not valid for production use") : console.error("Please provide a valid license key")
            ...
            }), this.currentItemsInDom = this.organizeSlideItems(s, -1), this.loadContent(s, !0), this.getSlideItem(s).addClass("lg-current"), this.index = s, this.updateCurrentCounter(s), this.LGel.trigger(n)) : this.closeGallery()
        }, t.prototype.getItems = function () {
            var t;
            return this.items = [], this.settings.dynamic ? this.settings.dynamicEl || [] : ("this" === this.settings.selector ? this.items.push(this.el) : this.settings.selector ? "string" == typeof this.settings.selector ? this.settings.selectWithin ? (t = T(this.settings.selectWithin), this.items = t.find(this.settings.selector).get()) : this.items = this.el.querySelectorAll(this.settings.selector) : this.items = this.settings.selector : this.items = this.el.children, B(this.items, this.settings.extraProps, this.settings.getCaptionFromTitleOrAlt, this.settings.exThumbImage))
        }, t.prototype.shouldHideScrollbar = function () {
            return this.settings.hideScrollbar && document.body === this.settings.container
        }, t.prototype.hideScrollbar = function () {
            var t;
            this.shouldHideScrollbar() && (this.bodyPaddingRight = parseFloat(T("body").style().paddingRight), t = document.documentElement.getBoundingClientRect(), t = window.innerWidth - t.width, T(document.body).css("padding-right", t + this.bodyPaddingRight + "px"), T(document.body).addClass("lg-overlay-open"))
        }, t.prototype.resetScrollBar = function () {
            this.shouldHideScrollbar() && (T(document.body).css("padding-right", this.bodyPaddingRight + "px"), T(document.body).removeClass("lg-overlay-open"))
        }, t.prototype.openGallery = function (e, t) {
            var i, s, n, o, r, l = this;
            void 0 === e && (e = this.settings.index), this.lgOpened || (this.lgOpened = !0, this.outer.removeClass("lg-hide-items"), this.hideScrollbar(), this.$container.addClass("lg-show"), o = this.getItemsToBeInsertedToDom(e, e), this.currentItemsInDom = o, i = "", o.forEach(function (t) {
            ...
            }, r), this.index = e, this.LGel.trigger(a), this.getSlideItem(e).addClass("lg-current"), this.lGalleryOn = !1, this.prevScrollTop = T(window).scrollTop(), setTimeout(function () {
                var t;
                ...
                }, l.settings.backdropDuration), l.slide(e, !1, !1, !1), l.LGel.trigger(d)
            }), document.body === this.settings.container && T("html").addClass("lg-on"))
            ...
            var e, i, s;
            this.galleryItems[t].subHtmlUrl ? i = this.galleryItems[t].subHtmlUrl : e = this.galleryItems[t].subHtml, i || (e ? "." !== (s = e.substring(0, 1)) && "#" !== s || (e = (this.settings.subHtmlSelectorRelative && !this.settings.dynamic ? T(this.items).eq(t).find(e) : T(e)).first().html()) : e = ""), ".lg-item" !== this.settings.appendSubHtmlTo ? i ? this.outer.find(".lg-sub-html").load(i) : this.outer.find(".lg-sub-html").html(e) : (s = T(this.getSlideItemId(t)), i ? s.load(i) : s.append('<div class="lg-sub-html">' + e + "</div>")), null != e && ("" === e ? this.outer.find(this.settings.appendSubHtmlTo).addClass("lg-empty-html") : this.outer.find(this.settings.appendSubHtmlTo).removeClass("lg-empty-html")), this.LGel.trigger(o, {
                index: t
            })
            ...
            if (s = this.settings.dynamic ? s : T(this.items).eq(e)) {
                e = void 0;
            ...
            var s = this.galleryItems[i],
                ...
                l = "",
                n = n ? 'alt="' + n + '"' : "",
                l = this.isFirstSlideWithZoomAnimation() ? this.getDummyImageContent(e, i, n) : z(i, t, n, o, r, s);
            e.prepend('<picture class="lg-img-wrap"> ' + l + "</picture>")
        }, t.prototype.onSlideObjectLoad = function (t, e, i, s) {
            t = t.find(".lg-object").first();
            G(t.get()) || e ? i() : (t.on("load.lg error.lg", function () {
                i && i()
            ...
            setTimeout(function () {
                t.addClass("lg-complete lg-complete_"), o.LGel.trigger(l, {
                    index: e,
                    delay: i || 0,
                    isFirstSlide: n
                })
            ...
            t.forEach(function (t, e) {
                t.__slideVideoInfo = H(t.src, !!t.video, e), t.__slideVideoInfo && i.settings.loadYouTubePoster && !t.poster && t.__slideVideoInfo.youtube && (t.poster = "//img.youtube.com/vi/" + t.__slideVideoInfo.youtube[1] + "/maxresdefault.jpg")
            })
        }, t.prototype.loadContent = function (e, t) {
            var i, s, n, o = this,
                r = this.galleryItems[e],
                l = T(this.getSlideItemId(e)),
                a = r.poster,
                d = r.srcset,
                g = r.sizes,
                h = r.sources,
            ...
            v && !T(document.body).hasClass("lg-from-hash") && (b = v), this.isFirstSlideWithZoomAnimation() && (setTimeout(function () {
                ...
                var t;
                "image" === o.getSlideType(r) && (t = (t = r.alt) ? 'alt="' + t + '"' : "", l.find(".lg-img-wrap").append(z(e, c, t, d, g, r.sources)), (d || h) && (t = l.find(".lg-object"), o.initPictureFill(t))), ("image" === o.getSlideType(r) || "video" === o.getSlideType(r) && a) && (o.onLgObjectLoad(l, e, v, b, !0, !1), o.onSlideObjectLoad(l, !(!m || !m.html5 || a), function () {
            ...
            "lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"), setTimeout(function () {
                ...
                r.outer.find(".lg-item").removeAttr("style"), t && Math.abs(i.pageX - s.pageX) < 5 && (e = T(n.target), r.isPosterElement(e) && r.LGel.trigger(g)), r.swipeDirection = void 0
            }), setTimeout(function () {
            ...
            this.settings.enableSwipe && (this.$inner.on("touchstart.lg", function (t) {
                ...
                !T(t.target).hasClass("lg-item") && !e.get().contains(t.target) || i.outer.hasClass("lg-zoomed") || i.lgBusy || 1 !== t.touches.length || (o = !0, i.touchAction = "swipe", i.manageSwipeClass(), s = {
                    pageX: t.touches[0].pageX,
                    pageY: t.touches[0].pageY
                })
            }), this.$inner.on("touchmove.lg", function (t) {
                o && "swipe" === i.touchAction && 1 === t.touches.length && (e = {
                    pageX: t.touches[0].pageX,
                    pageY: t.touches[0].pageY
                }, i.touchMove(s, e, t), n = !0)
            }), this.$inner.on("touchend.lg", function (t) {
                "swipe" === i.touchAction && (n ? (n = !1, i.touchEnd(e, s, t)) : o && (t = T(t.target), i.isPosterElement(t) && i.LGel.trigger(g)), i.touchAction = void 0, o = !1)
            }))
            ...
            this.settings.enableDrag && (this.outer.on("mousedown.lg", function (t) {
                i.dragOrSwipeEnabled = !0;
                var e = i.getSlideItem(i.index);
                !T(t.target).hasClass("lg-item") && !e.get().contains(t.target) || i.outer.hasClass("lg-zoomed") || i.lgBusy || (t.preventDefault(), i.lgBusy || (i.manageSwipeClass(), s = {
                    pageX: t.pageX,
                    pageY: t.pageY
                }, o = !0, i.outer.get().scrollLeft += 1, --i.outer.get().scrollLeft, i.outer.removeClass("lg-grab").addClass("lg-grabbing"), i.LGel.trigger(h)))
            }), T(window).on("mousemove.lg.global" + this.lgId, function (t) {
                o && i.lgOpened && (r = !0, n = {
                    pageX: t.pageX,
                    pageY: t.pageY
                }, i.touchMove(s, n), i.LGel.trigger(m))
            }), T(window).on("mouseup.lg.global" + this.lgId, function (t) {
                var e;
                i.lgOpened && (e = T(t.target), r ? (r = !1, i.touchEnd(n, s, t), i.LGel.trigger(p)) : i.isPosterElement(e) && i.LGel.trigger(g), o && (o = !1, i.outer.removeClass("lg-grabbing").addClass("lg-grab")))
            }))
        }, t.prototype.triggerPosterClick = function () {
            var e = this;
            this.$inner.on("click.lg", function (t) {
                !e.dragOrSwipeEnabled && e.isPosterElement(T(t.target)) && e.LGel.trigger(g)
            })
            ...
            t && this.galleryItems.length < 3 && (i = !1), this.lgBusy || (this.index + 1 < this.galleryItems.length ? (this.index++, this.LGel.trigger(r, {
                index: this.index
            }), this.slide(this.index, !!t, !1, "next")) : i ? (this.index = 0, this.LGel.trigger(r, {
                index: this.index
            ...
            var e = this,
                i = this.settings.loop;
            t && this.galleryItems.length < 3 && (i = !1), this.lgBusy || (0 < this.index ? (this.index--, this.LGel.trigger(f, {
                index: this.index,
                fromTouch: t
            }), this.slide(this.index, !!t, !1, "prev")) : i ? (this.index = this.galleryItems.length - 1, this.LGel.trigger(f, {
                index: this.index,
                fromTouch: t
            ...
            this.$container.get().focus({
                ...
                var e, i;
                !s.lgOpened || "Tab" !== t.key && 9 !== t.keyCode || (e = (i = A(s.$container.get()))[0], i = i[i.length - 1], t.shiftKey ? document.activeElement === e && (i.focus(), t.preventDefault()) : document.activeElement === i && (e.focus(), t.preventDefault()))
            })
            ...
            this.LGel.trigger(y), this.settings.resetScrollPosition && !this.settings.hideScrollbar && T(window).scrollTop(this.prevScrollTop);
            var i, s, n, o, t = this.items[this.index],
            ...
            return this.$container.removeClass("lg-show-in"), setTimeout(function () {
                e.zoomFromOrigin && o && e.outer.removeClass("lg-zoom-from-image"), e.$container.removeClass("lg-show"), e.resetScrollBar(), e.$backdrop.removeAttr("style").css("transition-duration", e.settings.backdropDuration + "ms"), e.outer.removeClass("lg-closing " + e.settings.startClass), e.getSlideItem(e.index).removeClass("lg-start-end-progress"), e.$inner.empty(), e.lgOpened && e.LGel.trigger(v, {
                    instance: e
            ...
            this.destroyModules(!0), this.settings.dynamic || this.invalidateItems(), T(window).off(".lg.global" + this.lgId), this.LGel.off(".lg"), this.$container.remove()
    ...
    function t(t, e) {
        ...
        if (P++, this.lgId = P, this.el = t, this.LGel = T(t), this.generateSettings(e), this.buildModules(), this.settings.dynamic && void 0 !== this.settings.dynamicEl && !Array.isArray(this.settings.dynamicEl)) throw "When using dynamic mode, you must also define dynamicEl as an Array.";
